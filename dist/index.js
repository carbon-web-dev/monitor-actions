...
const post_1 = __importDefault(__nccwpck_require__(95));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const url = core.getInput('webhook_url');
            const event = core.getInput('event');
            const label = core.getInput('monday_label');
            ...
            yield (0, post_1.default)({ url, event, label });
            core.debug(new Date().toTimeString());
...
const post_to_integromat = ({ url, event, label }) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.default = post_to_integromat;
